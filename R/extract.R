...
##' In such a case, because the ranges can be different for different fastq files in \code{all.qc}, this function will only mention the first base of the range in the ouput, here "11".
##' @param all.qc return value from readFastqcZips()
